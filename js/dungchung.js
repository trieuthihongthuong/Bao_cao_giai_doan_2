...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo1.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <p><a href="index.html">DaNang Shop</a> - All rights reserved © 2024 - Lập trình JavaScript Nhóm 8 </p>
